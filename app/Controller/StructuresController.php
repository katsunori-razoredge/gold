<?php
	class StructuresController extends AppController {
		...
		public function drawEditor() {
			...
			$bo = $this->Structure->find("5e9a1a84a0bc24d22a75d1a8");
			// echo(json_encode($bo));
			$this->set('aggregate', json_encode($bo));
			
			if ($this->request->query['id'] == '5e9a1a84a0bc24d22a75d1a8') {
				$this->render('r_i_sg');
			} else if ($this->request->query['id'] == '5e9a1a84a0bc24d22a75d1a8') {
